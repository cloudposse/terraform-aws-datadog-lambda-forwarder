...
| <a name="input_forwarder_lambda_datadog_host"></a> [forwarder\_lambda\_datadog\_host](#input\_forwarder\_lambda\_datadog\_host) | Define your Datadog Site to send data to | `string` | `datadoghq.com` | no |
