...
| <a name="input_s3_notification_events"></a> [s3\_notification\_events](#input\_s3\_notification\_events) | List of S3 events to trigger the Lambda notification | `list(string)` | <pre>[<br/>  "s3:ObjectCreated:*"<br/>]</pre> | no |
