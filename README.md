...
| <a name="input_lambda_timeout"></a> [lambda\_timeout](#input\_lambda\_timeout) | Amount of time your Datadog Lambda Function has to run in seconds. Defaults 120 as recommended by Datadog | `number` | `120` | no |
